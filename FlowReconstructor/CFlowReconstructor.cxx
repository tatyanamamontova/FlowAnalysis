...
void CFlowReconstructor::TH2toTH1withSampling (TH2 *h2In, TH1 *hOut, TDirectory *dir) {
    ...
    Float_t R, Rerr, xMin, xMax, xLow, xHigh, valuesFraction = 0.15;
    TDirectory *newDir;
    TH1F *hTemp;
    Double_t par [3];
    ...
    for (Int_t i = 1; i <= nBinsX; i++) {
        ...
        xMin = h2In -> ProjectionY ("", i, i) -> GetMinimum ();
        xMax = h2In -> ProjectionY ("", i, i) -> GetMaximum ();
        ...
        xLow = values [values.size() * valuesFraction];
        xHigh = values [(values.size() - 1) * (1 - valuesFraction)];
...
// test
    ...
    vector <TH1F*> hVxEtaReflMult_EP, hVyEtaReflMult_EP, hVEtaReflMult_EP, hVxYEtaReflMult_EP, hVyXEtaReflMult_EP;
        ...
        for (Int_t i = 0; i < nHarmonics; i++) {
			...
			h2RxaCent_SP.push_back (new TH2F (Form ("h2R%ixaCent_SP", n), Form ("R_{%i, a}^{x, SP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RxbCent_SP.push_back (new TH2F (Form ("h2R%ixbCent_SP", n), Form ("R_{%i, b}^{x, SP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RxcCent_SP.push_back (new TH2F (Form ("h2R%ixcCent_SP", n), Form ("R_{%i, c}^{x, SP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
            h2RyaCent_SP.push_back (new TH2F (Form ("h2R%iyaCent_SP", n), Form ("R_{%i, a}^{y, SP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RybCent_SP.push_back (new TH2F (Form ("h2R%iybCent_SP", n), Form ("R_{%i, b}^{y, SP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RycCent_SP.push_back (new TH2F (Form ("h2R%iycCent_SP", n), Form ("R_{%i, c}^{y, SP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
            h2RaCent_SP.push_back (new TH2F (Form ("h2R%iaCent_SP", n), Form ("R_{%i, a}^{x+y,SP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RbCent_SP.push_back (new TH2F (Form ("h2R%ibCent_SP", n), Form ("R_{%i, b}^{x+y,SP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RcCent_SP.push_back (new TH2F (Form ("h2R%icCent_SP", n), Form ("R_{%i, c}^{x+y,SP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
            h2RxaCent_EP.push_back (new TH2F (Form ("h2R%ixaCent_EP", n), Form ("R_{%i, a}^{x, EP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RxbCent_EP.push_back (new TH2F (Form ("h2R%ixbCent_EP", n), Form ("R_{%i, b}^{x, EP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RxcCent_EP.push_back (new TH2F (Form ("h2R%ixcCent_EP", n), Form ("R_{%i, c}^{x, EP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
            h2RyaCent_EP.push_back (new TH2F (Form ("h2R%iyaCent_EP", n), Form ("R_{%i, a}^{y, EP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RybCent_EP.push_back (new TH2F (Form ("h2R%iybCent_EP", n), Form ("R_{%i, b}^{y, EP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RycCent_EP.push_back (new TH2F (Form ("h2R%iycCent_EP", n), Form ("R_{%i, c}^{y, EP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
            h2RaCent_EP.push_back (new TH2F (Form ("h2R%iaCent_EP", n), Form ("R_{%i, a}^{x+y,EP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RbCent_EP.push_back (new TH2F (Form ("h2R%ibCent_EP", n), Form ("R_{%i, b}^{x+y,EP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RcCent_EP.push_back (new TH2F (Form ("h2R%icCent_EP", n), Form ("R_{%i, c}^{x+y,EP};cent;sample", n), nBinsCent_, centMin_, centMax_, nBinsBS_, 0.0, nBinsBS_));

			h2RxaMult_SP.push_back (new TH2F (Form ("h2R%ixaMult_SP", n), Form ("R_{%i, a}^{x, SP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RxbMult_SP.push_back (new TH2F (Form ("h2R%ixbMult_SP", n), Form ("R_{%i, b}^{x, SP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RxcMult_SP.push_back (new TH2F (Form ("h2R%ixcMult_SP", n), Form ("R_{%i, c}^{x, SP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
            h2RyaMult_SP.push_back (new TH2F (Form ("h2R%iyaMult_SP", n), Form ("R_{%i, a}^{y, SP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RybMult_SP.push_back (new TH2F (Form ("h2R%iybMult_SP", n), Form ("R_{%i, b}^{y, SP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RycMult_SP.push_back (new TH2F (Form ("h2R%iycMult_SP", n), Form ("R_{%i, c}^{y, SP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
            h2RaMult_SP.push_back (new TH2F (Form ("h2R%iaMult_SP", n), Form ("R_{%i, a}^{x+y,SP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RbMult_SP.push_back (new TH2F (Form ("h2R%ibMult_SP", n), Form ("R_{%i, b}^{x+y,SP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RcMult_SP.push_back (new TH2F (Form ("h2R%icMult_SP", n), Form ("R_{%i, c}^{x+y,SP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
            h2RxaMult_EP.push_back (new TH2F (Form ("h2R%ixaMult_EP", n), Form ("R_{%i, a}^{x, EP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RxbMult_EP.push_back (new TH2F (Form ("h2R%ixbMult_EP", n), Form ("R_{%i, b}^{x, EP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RxcMult_EP.push_back (new TH2F (Form ("h2R%ixcMult_EP", n), Form ("R_{%i, c}^{x, EP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
            h2RyaMult_EP.push_back (new TH2F (Form ("h2R%iyaMult_EP", n), Form ("R_{%i, a}^{y, EP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RybMult_EP.push_back (new TH2F (Form ("h2R%iybMult_EP", n), Form ("R_{%i, b}^{y, EP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RycMult_EP.push_back (new TH2F (Form ("h2R%iycMult_EP", n), Form ("R_{%i, c}^{y, EP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
            h2RaMult_EP.push_back (new TH2F (Form ("h2R%iaMult_EP", n), Form ("R_{%i, a}^{x+y,EP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RbMult_EP.push_back (new TH2F (Form ("h2R%ibMult_EP", n), Form ("R_{%i, b}^{x+y,EP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
			h2RcMult_EP.push_back (new TH2F (Form ("h2R%icMult_EP", n), Form ("R_{%i, c}^{x+y,EP};mult;sample", n), nBinsMh_, mhMin_, mhMax_, nBinsBS_, 0.0, nBinsBS_));
